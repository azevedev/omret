...
const STRINGS = {
  ...
  'pt-BR': {
    ...
    'settings.sound': 'Som',
    'settings.soundDesc': 'Efeitos sonoros para as teclas, as revelações e o fim da rodada.',
    ...
    'toast.mustPress': 'Essa casa é do <b>{letter}</b>. Só ele entra aqui',
  ...
  'en-US': {
    ...
    'settings.soundDesc': 'Sound effects for keys, reveals and the end of a round.',
    ...
    'toast.mustPress': 'This slot belongs to <b>{letter}</b>. Nothing else fits',
