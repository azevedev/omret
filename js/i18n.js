...
const STRINGS = {
  ...
  'pt-BR': {
    ...
    'help.intro':
      'Cada tentativa é marcada como no Termo normal. Mas aqui as marcas não são dicas, são <strong>regras que você é obrigado a seguir na próxima jogada.</strong>',
    'help.rule.locked':
      '<strong>Vermelho está travado.</strong> O <b>C</b> está na palavra, exatamente nessa casa. Agora ele está soldado à casa 1 — toda tentativa futura tem que começar com C.',
    'help.rule.required':
      '<strong>Âmbar precisa se mover.</strong> O <b>I</b> está na palavra, mas não aí. A partir de agora <em>todas</em> as letras âmbar precisam aparecer em <em>todas</em> as suas tentativas — e sempre numa casa onde ela nunca esteve. Você nunca pode simplesmente abandonar uma.',
    'help.rule.banned':
      '<strong>Cinza está morta.</strong> O <b>S</b> não está na palavra, então você nunca mais pode digitá-lo. Seguro por enquanto — mas seu alfabeto está encolhendo.',
    'help.rule.spent':
      '<strong>Hachurado quer dizer "não tem mais".</strong> Jogue REFER contra RETCH e aquele último <b>R</b> fica cinza — não porque o R morreu, mas porque o único R da palavra já foi reivindicado pelo vermelho. O R continua travado, então você ainda tem que usá-lo. Só as letras cinza lisas realmente acabaram.',
    'help.loseTitle': 'Como você perde',
    'help.lose.found': '<strong>Você digita a resposta.</strong> Derrota na hora. Óbvio.',
    'help.lose.cornered':
      '<strong>Você fica encurralado.</strong> As travas, as obrigações e as letras mortas apertam tanto que a única palavra que você ainda pode jogar <em>é</em> a resposta. A armadilha fecha sozinha.',
    'help.winTitle': 'Como você vence',
    'help.win': 'Sobreviva às cinco tentativas. Só isso. Desvie por cinco rodadas e você escapa.',
    'help.tip':
    ...
    'settings.commonDesc':
      'Limita as tentativas a cerca de 2.000 palavras do dia a dia. Desligar libera qualquer palavra do dicionário — o que torna a fuga fácil demais.',
    ...
    'settings.wordlistDesc':
      'Ferramenta de teste — lista todas as palavras, riscando e rebaixando cada uma conforme ela se torna injogável.',
  ...
  'en-US': {
    ...
    'help.lede': 'Guess the word <em>five times</em> — and whatever you do, <strong>don\'t find it.</strong>',
    'help.intro':
      'Every guess is marked exactly like normal Wordle. But here the marks aren\'t hints, they\'re <strong>rules you\'re forced to obey next turn.</strong>',
    'help.rule.locked':
      '<strong>Red is locked.</strong> <b>C</b> is in the word, in that exact spot. It is now welded to slot 1 — every future guess must start with C.',
    'help.rule.required':
      '<strong>Amber must move.</strong> <b>I</b> is in the word but not there. From now on <em>every</em> amber letter must appear in <em>every</em> guess you make — and each time in a slot it has never occupied before. You can never quietly drop one.',
    'help.rule.banned':
      '<strong>Gray is dead.</strong> <b>S</b> isn\'t in the word, so you may never type it again. Safe this turn — but your alphabet is shrinking.',
    'help.rule.spent':
      '<strong>Hatched means "no more of these".</strong> Guess REFER against RETCH and that last <b>R</b> greys out — not because R is dead, but because the word\'s only R was already claimed by the red one. R stays locked, so you still have to use it. Only flat gray letters are truly gone.',
    'help.loseTitle': 'How you lose',
    'help.lose.found': '<strong>You type the answer.</strong> Instant loss. Obviously.',
    'help.lose.cornered':
      '<strong>You get cornered.</strong> The locks, the obligations and the dead letters squeeze so hard that the only word you\'re still allowed to play <em>is</em> the answer. The trap closes on its own.',
    'help.winTitle': 'How you win',
    'help.win': 'Survive all five guesses. That\'s it. Dodge for five turns and you walk away.',
    'help.tip':
    ...
    'settings.commonDesc':
      'Restricts guesses to everyday words. Turning this off lets you play any dictionary word — which makes dodging far too easy.',
